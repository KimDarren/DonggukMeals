...
{
    // The identity color of this application.
    // Orange color.
    return [self colorWithRed:247.0f/255.0f green:144.0f/255.0f blue:30.0f/255.0f alpha:1.0f];
}
...
{
    return [self colorWithHexString:@"dbdbdb" alpha:.5f];
}
